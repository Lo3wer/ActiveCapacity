    ...
    return (
        <div className="mt-10 w-full">
            ...
            <div className="w-full flex justify-center items-center mt-3">
                ...
                <div className="w-full grid grid-cols-4 gap-2 text-[0.8rem] justify-center  bg-gray-200 rounded-4xl">
                    <div className={`w-full h-24 ${type == "Near Me" && "bg-gray-100"} rounded-4xl flex gap-2 flex-col justify-center items-center`}
                        onClick={() => setType("Near Me")}>

                        <Image src="/star.png" width={30} height={30} alt="yoga"></Image>
                        Near Me
                    </div>
                    <div className={`w-full h-24 ${type == "Courts" && "bg-gray-100"} rounded-4xl flex gap-2 flex-col justify-center items-center`}
                        onClick={() => setType("Courts")}>

                        <Image src="/court.png" width={30} height={30} alt="classes"></Image>
                        Courts
                    </div>
                    <div className={`w-full h-24 ${type == "Classes" && "bg-gray-100"} rounded-4xl flex gap-2 flex-col justify-center items-center`}
                        onClick={() => setType("Classes")}>

                        <Image src="/yoga.png" width={30} height={30} alt="yoga"></Image>
                        Classes
                    </div>
                    <div className={`w-full h-24 ${type == "Gyms" && "bg-gray-100"} rounded-4xl flex gap-2 flex-col justify-center items-center`}
